...
1. Clone repositori ke perangkat lokal:
    ...
    git clone [https://github.com/PutriHeptiAmelia/baseproject-pengajuan-akademik.git](https://github.com/PutriHeptiAmelia/baseproject-pengajuan-akademik.git)
